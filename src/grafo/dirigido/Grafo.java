...
public class Grafo<T> {
	...
	public IteradorBFS<T> createIteradorBFS(T verticeInicial){

		Vertice vertice = getVertice(verticeInicial);
		
		return new IteradorBFS<>(this, vertice);
	}
	
	public IteradorDFS<T> createIteradorDFS(T verticeInicial){
		Vertice vertice = getVertice(verticeInicial);
		return new IteradorDFS<>(this, vertice);
	}
